...
function SignUpPage() {
  ...
  const validateForm = () => {
    ...
    if (formData.password.length < 6) return toast.error("Password must be greater than 6");
    return true;
  };
  ...
  return (
    <div className=" min-h-screen grid lg:grid-cols-2">
          ...
          <form action="" onSubmit={handleSubmit} className=" space-y-6">
            <div className="form-control">
              ...
              <div className="relative">
                ...
                <input
                  type="text"
                  className={`input input-bordered pl-10 w-full bg-transparent`}
      ...
      subtitle={"Connect with friends ,share moments ,and stay with touch wiith your loved once"}
      />
    </div>
  );
}
